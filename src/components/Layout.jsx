...
const Layout = () => {
    ...
    const navItems = [
        ...
        { name: 'Uploads', path: '/api/upload', icon: <UploadCloud size={20} /> },
        { name: 'Resumes', path: '/api/resume', icon: <FileText size={20} /> },
        { name: 'Invoices', path: '/api/invoice', icon: <Receipt size={20} /> },
        { name: 'Loans', path: '/api/loan', icon: <CreditCard size={20} /> },
        { name: 'Passports', path: '/api/passport', icon: <Globe size={20} /> },
        { name: 'ID-Proofs', path: '/api/idproof', icon: <BadgeCheck size={20} /> },
    ];
